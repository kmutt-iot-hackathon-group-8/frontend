...
const NavBar = () => {
  ...
  if (isLoading) {
    return <nav className="w-full h-20 bg-white" />;
  }
      ...
      <div className="flex items-center gap-4 md:gap-8 mr-0">
        ...
        >
          <button
            ...
            style={{
              background: "linear-gradient(90deg, #AFEEDD 0%, #6CB2D7 100%)",
            }}
          >
            <User
          ...
          {isProfileOpen && (
            <div
              className="absolute right-0 -mt-3 w-52 flex flex-col z-50 font-montserrat"
              style={{ filter: "drop-shadow(0px 4px 4px rgba(0, 0, 0, 0.25))" }}
            >
              <button
                onClick={() => navigate("/profile")}
                className="flex items-center gap-3 pl-6 pr-4 h-11.75 bg-[#F4F7F8] rounded-t-md hover:bg-[#A8BFC6] transition-colors cursor-pointer"
              >
                ...
                <span className="font-bold text-[14px] leading-4.25 text-[#1E1E1E]">
                  View Profile
                </span>
              </button>
              ...
              <button
                ...
                className="flex items-center gap-3 pl-6 pr-4 h-11.75 bg-[#F4F7F8] hover:bg-[#A8BFC6] transition-colors cursor-pointer"
              >
                <div className="w-6 h-6 flex items-center justify-center shrink-0">
                  <img
                    src={createdEventIcon}
                    alt="Created Events"
                    className="max-w-full max-h-full object-contain"
                  />
                </div>
              ...
              <button
                ...
                className="flex items-center gap-3 pl-6  pr-4 h-11.5 bg-[#F4F7F8] hover:bg-[#A8BFC6] transition-colors cursor-pointer"
              >
                <div className="w-6 h-6 flex items-center justify-center shrink-0">
                  <img
                    src={attEventIcon}
